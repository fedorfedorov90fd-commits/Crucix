...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-rest-countries.html` |
| API | `apis/sources/collect-rest-countries.mjs` |
| Help | `docs/help/en/collect-rest-countries.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-global-price.html` |
| API | `apis/sources/collect-global-price.mjs` |
| Help | `docs/help/en/collect-global-price.md` |

# Collect Dark Ships Real Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-dark-ships-real.html` |
| API | `apis/sources/collect-dark-ships-real.mjs` |
| Help | `docs/help/en/collect-dark-ships-real.md` |

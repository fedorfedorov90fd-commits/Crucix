...
| File | Path |
|------|------|
| Page | `dashboard/public/collector-config-api.html` |
| API | `apis/sources/collector-config-api.mjs` |
| Help | `docs/help/en/collector-config-api.md` |

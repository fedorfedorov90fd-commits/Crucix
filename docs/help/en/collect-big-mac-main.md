...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-big-mac-main.html` |
| API | `apis/sources/collect-big-mac-main.mjs` |
| Help | `docs/help/en/collect-big-mac-main.md` |

...
The `advanced` module — component of Crucix predictive core.
File: `dashboard/advanced.html` (8449 B, 172 lines, version —).
...
| File | Path |
|------|------|
| Module | `dashboard/advanced.html` |
...
🟢 Active. File exists, size 8449 B.

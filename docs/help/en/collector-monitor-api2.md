...
| File | Path |
|------|------|
| Page | `dashboard/public/collector-monitor-api2.html` |
| API | `apis/sources/collector-monitor-api2.mjs` |
| Help | `docs/help/en/collector-monitor-api2.md` |

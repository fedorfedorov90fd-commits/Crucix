# Collect Aviation Monitor Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-aviation-monitor.html` |
| API | `apis/sources/collect-aviation-monitor.mjs` |
| Help | `docs/help/en/collect-aviation-monitor.md` |

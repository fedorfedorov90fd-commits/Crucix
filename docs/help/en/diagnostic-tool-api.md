...
| File | Path |
|------|------|
| Page | `dashboard/public/diagnostic-tool-api.html` |
| API | `apis/sources/diagnostic-tool-api.mjs` |
| Help | `docs/help/en/diagnostic-tool-api.md` |

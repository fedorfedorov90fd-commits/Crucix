...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-gps-jamming.html` |
| API | `apis/sources/collect-gps-jamming.mjs` |
| Help | `docs/help/en/collect-gps-jamming.md` |

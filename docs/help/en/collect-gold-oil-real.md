...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-gold-oil-real.html` |
| API | `apis/sources/collect-gold-oil-real.mjs` |
| Help | `docs/help/en/collect-gold-oil-real.md` |

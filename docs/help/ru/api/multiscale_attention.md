...
**Русский:**
Модуль `multiscale_attention` — Multi-scale Attention Dynamics Моделирование внимания одновременно на нескольких временных горизонтах..
Файл: `apis/predict/multiscale_attention.mjs` (15179 B, 431 строк, версия —).
...
| Файл / File | Путь / Path |
|-------------|-------------|
| Модуль / Module | `apis/predict/multiscale_attention.mjs` |
| Оркестратор / Orchestrator | `apis/predict/engine.mjs` |
| Реестр / Registry | `apis/predict/register_coordinat_all.mjs` |
| Справка RU / Help RU | `docs/help/ru/api/multiscale_attention.md` |
| Справка EN / Help EN | `docs/help/en/api/multiscale_attention.md` |
...
**Русский:**
🟢 Активен. Файл найден, размер 15179 B.

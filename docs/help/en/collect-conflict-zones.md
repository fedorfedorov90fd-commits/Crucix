...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-conflict-zones.html` |
| API | `apis/sources/collect-conflict-zones.mjs` |
| Help | `docs/help/en/collect-conflict-zones.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-big-mac-alt.html` |
| API | `apis/sources/collect-big-mac-alt.mjs` |
| Help | `docs/help/en/collect-big-mac-alt.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-earthquakes.html` |
| API | `apis/sources/collect-earthquakes.mjs` |
| Help | `docs/help/en/collect-earthquakes.md` |

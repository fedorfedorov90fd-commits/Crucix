...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-daily-report.html` |
| API | `apis/sources/collect-daily-report.mjs` |
| Help | `docs/help/en/collect-daily-report.md` |

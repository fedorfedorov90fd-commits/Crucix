...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-gold-silver.html` |
| API | `apis/sources/collect-gold-silver.mjs` |
| Help | `docs/help/en/collect-gold-silver.md` |

// Sputnik — новостное агентство
export async function briefing() {
  try {
    const response = await fetch('https://sputnikglobe.com/export/rss2/archive/index.xml', {
      headers: {
    ...
    console.error(`[Sputnik] Загружено ${items.length} новостей`);
    ...
    console.error('[Sputnik] Ошибка:', error.message);
    return {
      source: 'Sputnik',
      timestamp: new Date().toISOString(),
...
if (process.argv[1]?.endsWith('sputnik.mjs')) {

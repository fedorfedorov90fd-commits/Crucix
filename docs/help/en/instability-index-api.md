...
| File | Path |
|------|------|
| Page | `dashboard/public/instability-index-api.html` |
| API | `apis/sources/instability-index-api.mjs` |
| Help | `docs/help/en/instability-index-api.md` |

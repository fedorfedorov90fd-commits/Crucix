...
| File | Path |
|------|------|
| Page | `dashboard/public/internet-outages-api.html` |
| API | `apis/sources/internet-outages-api.mjs` |
| Help | `docs/help/en/internet-outages-api.md` |

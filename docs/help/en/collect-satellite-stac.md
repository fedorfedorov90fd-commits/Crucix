...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-satellite-stac.html` |
| API | `apis/sources/collect-satellite-stac.mjs` |
| Help | `docs/help/en/collect-satellite-stac.md` |

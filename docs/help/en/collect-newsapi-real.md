...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-newsapi-real.html` |
| API | `apis/sources/collect-newsapi-real.mjs` |
| Help | `docs/help/en/collect-newsapi-real.md` |

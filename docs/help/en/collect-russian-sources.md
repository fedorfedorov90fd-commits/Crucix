# Collect Russian Sources Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-russian-sources.html` |
| API | `apis/sources/collect-russian-sources.mjs` |
| Help | `docs/help/en/collect-russian-sources.md` |

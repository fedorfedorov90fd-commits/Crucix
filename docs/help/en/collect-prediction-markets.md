# Collect Prediction Markets Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-prediction-markets.html` |
| API | `apis/sources/collect-prediction-markets.mjs` |
| Help | `docs/help/en/collect-prediction-markets.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-gold-oil-ratio.html` |
| API | `apis/sources/collect-gold-oil-ratio.mjs` |
| Help | `docs/help/en/collect-gold-oil-ratio.md` |

# Collect Consumer Confidence Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-consumer-confidence.html` |
| API | `apis/sources/collect-consumer-confidence.mjs` |
| Help | `docs/help/en/collect-consumer-confidence.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-copper-gold.html` |
| API | `apis/sources/collect-copper-gold.mjs` |
| Help | `docs/help/en/collect-copper-gold.md` |

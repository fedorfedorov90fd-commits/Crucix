/**
 * scripts/reference/alpha2-table.mjs
 * Полная таблица ISO 3166-1 alpha-2 (код из 2 букв) для связки с ISO3.
 * Источник: ISO 3166-1 official.
 * НЕ ЯВЛЯЕТСЯ API-МОДУЛЕМ. Используется генератором countries.json.
 */

export const ALPHA2_TO_ISO3 = {

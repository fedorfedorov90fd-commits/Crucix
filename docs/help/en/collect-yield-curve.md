...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-yield-curve.html` |
| API | `apis/sources/collect-yield-curve.mjs` |
| Help | `docs/help/en/collect-yield-curve.md` |

// British Antarctic Survey — новости Антарктики
export async function briefing() {
  try {
    const response = await fetch('https://www.bas.ac.uk/news/feed/', {
      headers: {
    ...
    console.error(`[British Antarctic Survey] Загружено ${items.length} новостей`);
    ...
    console.error('[British Antarctic Survey] Ошибка:', error.message);
    return {
      source: 'British Antarctic Survey',
      timestamp: new Date().toISOString(),
...
if (process.argv[1]?.endsWith('bas.mjs')) {

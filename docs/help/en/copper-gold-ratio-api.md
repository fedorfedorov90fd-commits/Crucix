...
| File | Path |
|------|------|
| Page | `dashboard/public/copper-gold-ratio-api.html` |
| API | `apis/sources/copper-gold-ratio-api.mjs` |
| Help | `docs/help/en/copper-gold-ratio-api.md` |

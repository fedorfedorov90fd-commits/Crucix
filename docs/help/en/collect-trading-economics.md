# Collect Trading Economics Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-trading-economics.html` |
| API | `apis/sources/collect-trading-economics.mjs` |
| Help | `docs/help/en/collect-trading-economics.md` |

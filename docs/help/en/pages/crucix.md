...
The `crucix` module — component of Crucix predictive core.
File: `dashboard/crucix.html` (22450 B, 456 lines, version —).
...
🟢 Active. File exists, size 22450 B.

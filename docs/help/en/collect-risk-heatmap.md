...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-risk-heatmap.html` |
| API | `apis/sources/collect-risk-heatmap.mjs` |
| Help | `docs/help/en/collect-risk-heatmap.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-aviation-real.html` |
| API | `apis/sources/collect-aviation-real.mjs` |
| Help | `docs/help/en/collect-aviation-real.md` |

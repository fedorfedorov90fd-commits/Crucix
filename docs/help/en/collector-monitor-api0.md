...
| File | Path |
|------|------|
| Page | `dashboard/public/collector-monitor-api0.html` |
| API | `apis/sources/collector-monitor-api0.mjs` |
| Help | `docs/help/en/collector-monitor-api0.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/war-preparation-api.html` |
| API | `apis/sources/war-preparation-api.mjs` |
| Help | `docs/help/en/war-preparation-api.md` |

/**
 * apis/sources/reports-api.mjs — API-МОДУЛЬ
 *
 * КОНТРАКТ CRUCIX v2.
 * ИСТОЧНИК: data/basket/reports.json (файл данных отсутствует — данные нужно собрать коллектором).
 * Сборщик: collect-reports.mjs.
 *
...
export const route  = '/api/layers/reports';
...
export const meta = {
  ...
  vizType: "marker",
  source: null,
  collector: "collect-reports.mjs",
  cache: 300,
  description: "Слой reports",
  unit: "records",
};

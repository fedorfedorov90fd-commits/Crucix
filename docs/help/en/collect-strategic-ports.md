# Collect Strategic Ports Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-strategic-ports.html` |
| API | `apis/sources/collect-strategic-ports.mjs` |
| Help | `docs/help/en/collect-strategic-ports.md` |

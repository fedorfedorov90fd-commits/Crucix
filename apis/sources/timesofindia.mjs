// Times of India — индийская газета
export async function briefing() {
  try {
    ...
    console.error(`[Times of India] Загружено ${items.length} новостей`);
    ...
    console.error('[Times of India] Ошибка:', error.message);
    return {
      source: 'Times of India',
      timestamp: new Date().toISOString(),
...
if (process.argv[1]?.endsWith('timesofindia.mjs')) {

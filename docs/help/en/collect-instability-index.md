# Collect Instability Index Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-instability-index.html` |
| API | `apis/sources/collect-instability-index.mjs` |
| Help | `docs/help/en/collect-instability-index.md` |

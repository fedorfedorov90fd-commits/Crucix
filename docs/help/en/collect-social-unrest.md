...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-social-unrest.html` |
| API | `apis/sources/collect-social-unrest.mjs` |
| Help | `docs/help/en/collect-social-unrest.md` |

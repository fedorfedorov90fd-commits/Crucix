...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-opensanctions.html` |
| API | `apis/sources/collect-opensanctions.mjs` |
| Help | `docs/help/en/collect-opensanctions.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/prediction-markets-api.html` |
| API | `apis/sources/prediction-markets-api.mjs` |
| Help | `docs/help/en/prediction-markets-api.md` |

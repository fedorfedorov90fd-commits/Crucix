...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-unemployment.html` |
| API | `apis/sources/collect-unemployment.mjs` |
| Help | `docs/help/en/collect-unemployment.md` |

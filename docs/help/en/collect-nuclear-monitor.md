# Collect Nuclear Monitor Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-nuclear-monitor.html` |
| API | `apis/sources/collect-nuclear-monitor.mjs` |
| Help | `docs/help/en/collect-nuclear-monitor.md` |

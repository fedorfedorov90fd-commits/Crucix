...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-space-track.html` |
| API | `apis/sources/collect-space-track.mjs` |
| Help | `docs/help/en/collect-space-track.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-cyber-attacks.html` |
| API | `apis/sources/collect-cyber-attacks.mjs` |
| Help | `docs/help/en/collect-cyber-attacks.md` |

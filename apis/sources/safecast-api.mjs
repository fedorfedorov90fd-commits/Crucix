...
const DATA_FILE = join(BASKET_DIR, 'safecast-data.json');
...
export async function handleSafecastAPI(req, res) {
  ...
  try {
    // GET /api/safecast/data — данные радиационного мониторинга
    if (path === '/api/safecast/data' && req.method === 'GET') {
      try {
...
export default { handleSafecastAPI };

# Consumer Confidence Api Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/consumer-confidence-api.html` |
| API | `apis/sources/consumer-confidence-api.mjs` |
| Help | `docs/help/en/consumer-confidence-api.md` |

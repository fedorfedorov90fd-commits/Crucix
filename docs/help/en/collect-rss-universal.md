...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-rss-universal.html` |
| API | `apis/sources/collect-rss-universal.mjs` |
| Help | `docs/help/en/collect-rss-universal.md` |

...
async function main() {
  ...
  const payload = {
    _meta: { id: 'pizza-index', category: 'detector', version: '1.0.0', schema_version: '1.0.0', sources: ['google-trends.json'], calculator: 'PizzaIndex', updated_at: now, duration_ms: Date.now() - t0, checksum: '', stats: { items_processed: count, total_result: all.length } },
  ...
  console.log('pizza-index v1.0.0 — items:', count, ', result:', all.length);
}

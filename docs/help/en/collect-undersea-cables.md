# Collect Undersea Cables Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-undersea-cables.html` |
| API | `apis/sources/collect-undersea-cables.mjs` |
| Help | `docs/help/en/collect-undersea-cables.md` |

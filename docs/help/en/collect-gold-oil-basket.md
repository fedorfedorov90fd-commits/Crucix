# Collect Gold Oil Basket Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-gold-oil-basket.html` |
| API | `apis/sources/collect-gold-oil-basket.mjs` |
| Help | `docs/help/en/collect-gold-oil-basket.md` |

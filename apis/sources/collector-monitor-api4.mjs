// ============================================================
// collector-monitor-api.mjs — Мониторинг сборщиков (v3.2)
// ============================================================
// Объединённая версия:
//   - resolveProjectRoot() — синхронная, с existsSync
//   - EXPECTED_COUNTS для каждого сборщика
//   - hasExpected — проверка, достигнуто ли 50% от ожидаемого
//   - Все эндпоинты: /status, /summary, /scan, /errors, /logs/:name
// ============================================================

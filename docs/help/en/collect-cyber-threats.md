...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-cyber-threats.html` |
| API | `apis/sources/collect-cyber-threats.mjs` |
| Help | `docs/help/en/collect-cyber-threats.md` |

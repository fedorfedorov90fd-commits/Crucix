// The Hindu — индийская газета
export async function briefing() {
  try {
    const response = await fetch('https://www.thehindu.com/feeder/default.rss', {
      headers: {
    ...
    console.error(`[The Hindu] Загружено ${items.length} новостей`);
    ...
    console.error('[The Hindu] Ошибка:', error.message);
    return {
      source: 'The Hindu',
      timestamp: new Date().toISOString(),
...
if (process.argv[1]?.endsWith('thehindu.mjs')) {

# Collect War Preparation Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-war-preparation.html` |
| API | `apis/sources/collect-war-preparation.mjs` |
| Help | `docs/help/en/collect-war-preparation.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collector-monitor-api1.html` |
| API | `apis/sources/collector-monitor-api1.mjs` |
| Help | `docs/help/en/collector-monitor-api1.md` |

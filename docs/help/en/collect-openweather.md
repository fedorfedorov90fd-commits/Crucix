...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-openweather.html` |
| API | `apis/sources/collect-openweather.mjs` |
| Help | `docs/help/en/collect-openweather.md` |

...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-crypto-fear.html` |
| API | `apis/sources/collect-crypto-fear.mjs` |
| Help | `docs/help/en/collect-crypto-fear.md` |

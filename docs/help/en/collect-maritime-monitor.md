# Collect Maritime Monitor Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-maritime-monitor.html` |
| API | `apis/sources/collect-maritime-monitor.mjs` |
| Help | `docs/help/en/collect-maritime-monitor.md` |

# Collect Internet Outages Module
...
| File | Path |
|------|------|
| Page | `dashboard/public/collect-internet-outages.html` |
| API | `apis/sources/collect-internet-outages.mjs` |
| Help | `docs/help/en/collect-internet-outages.md` |
